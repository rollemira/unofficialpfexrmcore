...
namespace Microsoft.Pfe.Xrm
{
    public static class SecurityExtensions
    {
        ...
        private static readonly byte[] additionalEntropy = Encoding.Unicode.GetBytes("replacewithyourentropykey");
        ...
        {
            if (value == null) throw new ArgumentNullException("value", "Cannot convert null value.ToUnsecureString()");
        ...
        {
            if (value == null) throw new ArgumentNullException("value", "Cannot encrypt a null SecureString value");

            var encryptedValue = ProtectedData.Protect(Encoding.Unicode.GetBytes(value.ToUnsecureString()),
        ...
        public static SecureString ToSecureString(this string value)
        {
            ...
            value.ToCharArray().ToList().ForEach(c => { secureValue.AppendChar(c); });
        ...
        /// </remarks>
        /// <exception cref="CryptographicException">
        ///     This method calls ProtectedData.Unprotect(). Callers of this method should handle potential cryptographic
        ///     exceptions.
        /// </exception>
        public static SecureString ToDecryptedSecureString(this string value)
        {
            ...
            var decryptedValue = ProtectedData.Unprotect(Convert.FromBase64String(value), additionalEntropy,
