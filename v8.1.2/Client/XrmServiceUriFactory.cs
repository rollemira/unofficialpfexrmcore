...
namespace Microsoft.Pfe.Xrm
{
    ...
    public static class XrmServiceUriFactory
    {
        ...
        public static Uri DiscoveryServiceOnlineO365NAUri =
            new Uri("https://disco.crm.dynamics.com/XRMServices/2011/Discovery.svc");

        public static Uri DiscoveryServiceOnlineLiveNAUri =
            new Uri("https://dev.crm.dynamics.com/XRMServices/2011/Discovery.svc");

        public static Uri DiscoveryServiceOnlineO365EMEAUri =
            new Uri("https://disco.crm4.dynamics.com/XRMServices/2011/Discovery.svc");

        public static Uri DiscoveryServiceOnlineLiveEMEAUri =
            new Uri("https://dev.crm4.dynamics.com/XRMServices/2011/Discovery.svc");

        public static Uri DiscoveryServiceOnlineO365APACUri =
            new Uri("https://disco.crm5.dynamics.com/XRMServices/2011/Discovery.svc");

        public static Uri DiscoveryServiceOnlineLiveAPACUri =
            new Uri("https://dev.crm5.dynamics.com/XRMServices/2011/Discovery.svc");
        ...
        {
            return CreateServiceUri(location, XrmServiceType.Discovery);
        }
        ...
        /// </summary>
        /// <param name="location">
        ///     The scheme, host, port # (if applicable), and organization representing location of
        ///     Organization.svc
        /// </param>
        /// <returns>A new instance of <see cref="Uri" /> for the Organization.svc</returns>
        /// <remarks>
        ///     EXAMPLES: https://hostname:5555/organization, https://organization.hostname:5555, https://hostname/organization,
        ...
        ///     The Organization.svc endpoint path is not necessary as this will be appended to all <see cref="Uri" />'s based on
        ///     the type specified
        /// </remarks>
        public static Uri CreateOrganizationServiceUri(string location)
        {
            return CreateServiceUri(location, XrmServiceType.Organization);
        }
        ...
        ///     https://organization.hostname
        ///     The organization name, if detected in the <see cref="Uri" /> path, is preserved in the resulting <see cref="Uri" />
        ///     The OrganizationData.svc endpoint path is not necessary as this will be appended to all <see cref="Uri" />'s based
        ///     on the type specified
        /// </remarks>
        public static Uri CreateOrganizationDataServiceUri(string location)
        {
            return CreateServiceUri(location, XrmServiceType.OrganizationData);
        }
        ...
        ///     https://organization.hostname
        ///     The organization name, if detected in the <see cref="Uri" /> path, is preserved in the resulting <see cref="Uri" />
        ///     The Organization.svc/Web endpoint path is not necessary as this will be appended to all <see cref="Uri" />'s based
        ///     on the type specified
        /// </remarks>
        public static Uri CreateOrganizationWebServiceUri(string location)
        {
            return CreateServiceUri(location, XrmServiceType.OrganizationWeb);
        }

        /// <summary>
        ///     Creates an Organization.svc <see cref="Uri" /> instance targeting CRM Online for the specified organization/region
        ///     pair
        /// </summary>
        ...
        /// <returns>A new instance of <see cref="Uri" /> for the Organization.svc</returns>
        public static Uri CreateOnlineOrganizationServiceUri(string organizationName,
            CrmOnlineRegion region = CrmOnlineRegion.NA)
        {
            var location = CreateOnlineOrganizationServiceLocation(organizationName, region);

            return CreateOrganizationServiceUri(location);
        }

        /// <summary>
        ///     Creates an OrganizationData.svc <see cref="Uri" /> instance targeting CRM Online for the specified
        ///     organization/region pair
        /// </summary>
        /// <param name="organizationName">The organization name</param>
        /// <param name="region">The region where the organization is located</param>
        /// <returns>A new instance of <see cref="Uri" /> for the OrganizationData.svc</returns>
        public static Uri CreateOnlineOrganizationDataServiceUri(string organizationName,
            CrmOnlineRegion region = CrmOnlineRegion.NA)
        {
            var location = CreateOnlineOrganizationServiceLocation(organizationName, region);

            return CreateOrganizationDataServiceUri(location);
        }

        /// <summary>
        ///     Creates an Organization.svc/Web <see cref="Uri" /> instance targeting CRM Online for the specified
        ///     organization/region pair
        /// </summary>
        /// <param name="organizationName">The organization name</param>
        /// <param name="region">The region where the organization is located</param>
        /// <returns>A new instance of <see cref="Uri" /> for the Organization.svc/Web</returns>
        public static Uri CreateOnlineOrganizationWebServiceUri(string organizationName,
            CrmOnlineRegion region = CrmOnlineRegion.NA)
        {
            var location = CreateOnlineOrganizationServiceLocation(organizationName, region);

            return CreateOrganizationWebServiceUri(location);
        }
        ...
        /// </summary>
        /// <param name="location">
        ///     The location of the Dynamics CRM endpoint - This should include scheme, host, port, and
        ...
        /// <remarks>
        ///     EXAMPLES: https://hostname:4443/organization, https://hostname/organization, https://organization.hostname,
        ///     https://hostname
        ///     For Organization.svc types, the organization name, if detected in the <see cref="Uri" /> path, is preserved in the
        ///     resulting <see cref="Uri" />
        ///     The Dynamics CRM service endpoint path is not necessary as this will be appended to all <see cref="Uri" />'s based
        ///     on the type specified
        /// </remarks>
        private static Uri CreateServiceUri(string location, XrmServiceType serviceType)
        {
            ...
            if (Uri.TryCreate(location, UriKind.Absolute, out providedUri))
            {
                ...
                var providedAuthority = providedUri.GetLeftPart(UriPartial.Authority);
                ...
                if (serviceType != XrmServiceType.Discovery && providedUri.Segments.Length > 1 && !providedUri
                        .Segments[1].Equals(@"XRMServices/", StringComparison.OrdinalIgnoreCase))
                {
                ...
                switch (serviceType)
                {
                    case XrmServiceType.Discovery:
                        pathBuilder.Append(DiscoveryServicePath);
                        break;
                    case XrmServiceType.Organization:
                        pathBuilder.Append(OrganizationServicePath);
                        break;

                    case XrmServiceType.OrganizationData:
                        pathBuilder.Append(OrganizationDataServicePath);
                        break;

                    case XrmServiceType.OrganizationWeb:
                        pathBuilder.Append(OrganizationWebServicePath);
                        break;
                }
        ...
        private static string CreateOnlineOrganizationServiceLocation(string organizationName, CrmOnlineRegion region)
        {
            switch (region)
            {
                ...
                default: return string.Format(OrganizationServiceOnlineNAUriFormat, organizationName);
                case CrmOnlineRegion.EMEA:
                    return string.Format(OrganizationServiceOnlineEMEAUriFormat, organizationName);
                case CrmOnlineRegion.APAC:
                    return string.Format(OrganizationServiceOnlineAPACUriFormat, organizationName);
            }
        }
    }
}